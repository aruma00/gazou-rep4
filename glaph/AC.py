...
prob_new += new_price_A * A_new + initial_price_B * B_new + new_price_C * C_new + initial_price_D * D_new, "Profit"
...
plt.title('Change in profit due to price change of products A and C')
plt.xlabel('Pricing')
