...
# 広告費を1000ドルから500ドルまで50ドルずつ減少
ad_cost_range = list(range(1000, 449, -50))
...
plt.title('Changes in profits and optimal production due to reduced advertising expenditure')
...
plt.xlabel('Advertising cost (dollars)')
